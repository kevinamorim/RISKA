...
public class RiskaSliderFloat extends RiskaItem {
	...
	public RiskaSliderFloat(float pX, float pY, float minBound, float maxBound, RiskaSprite pBackground, RiskaSprite pSlider)
	{
		super(pX, pY);
