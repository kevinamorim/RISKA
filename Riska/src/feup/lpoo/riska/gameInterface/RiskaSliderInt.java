...
public class RiskaSliderInt extends RiskaItem {
	...
	public RiskaSliderInt(float pX, float pY, int minBound, int maxBound, int pStep, RiskaSprite pBackground, RiskaSprite pSlider)
	{
		super(pX, pY);
