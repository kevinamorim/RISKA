...
public class RiskaMenuSliderList extends RiskaMenuItem {
	...
	public RiskaMenuSliderList(float pX, float pY, ArrayList<String> pValues, RiskaSprite pBackground, RiskaSprite pSlider)
	{
		super(pX, pY);
	...
	public RiskaMenuSliderList(float pX, float pY, RiskaSprite pBackground, RiskaSprite pSlider)
	{
